...
use crate::db::{
    ...
    calculate_player_opening_families_stats, calculate_player_openings_stats,
    calculate_player_rating_timeline, calculate_player_sidebar_model, clear_games, convert_pgn,
    create_event_game, create_indexes, delete_database, delete_db_game, delete_empty_games,
    delete_indexes, delete_managed_event, download_game_database, download_position_cache,
    export_position_games_to_pgn, export_selected_games_to_pgn,
    export_selected_games_to_single_pgn, export_to_pgn, fill_missing_months_data,
    ...
    get_profile_fork_stats, get_profile_game_info, get_profile_game_stats,
    get_profile_intensity_accuracy, get_profile_intensity_breakdown, get_profile_intensity_games,
    get_profile_intensity_outcomes, get_profile_missed_fork_games,
    get_profile_opening_families_stats, get_profile_openings_stats, get_profile_outcome_accuracy,
    ...
    get_profile_weakness_model, get_tournaments, import_fide_broadcast_games_to_profile,
    import_online_tournament, init_profile_db, list_account_sync_completed_batches,
    list_managed_events, mark_account_sync_batch_complete, merge_player_site_stats,
    merge_profile_event_from_db_player, merge_years_data, optimize_database, precache_openings,
    replace_profile_db_file, save_profile_game_analysis_stats, search_position, set_db_source,
...
pub async fn run() {
    ...
    let specta_builder = tauri_specta::Builder::new()
        .commands(tauri_specta::collect_commands!(
            ...
            get_profile_game_info,
            get_profile_sidebar_stats,
            get_profile_game_stats,
            get_profile_opening_families_stats,
            get_profile_openings_stats,
            ...
            optimize_database,
            export_to_pgn,
            export_selected_games_to_single_pgn,
            ...
            calculate_player_opening_families_stats,
            ...
            import_fide_broadcast_games_to_profile,
            get_lichess_account,
